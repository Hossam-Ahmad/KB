...
Route::group(['prefix' => 'Hubb_api', 'middleware' => 'guest'], function () {
    Route::post('KBsearch', 'TeamController@searchApi');
    Route::post('create', 'TeamController@createApi');
    Route::post('terminate', 'TeamController@terminateApi');
    Route::post('update_Subdomain', 'TeamController@update_SubdomainApi');
