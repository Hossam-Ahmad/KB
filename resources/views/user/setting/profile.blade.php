                ...
                <div class="user-info">
                    ...
                    <form action="{{ route('users.update', [$team->slug, Auth::user()->slug]) }}" method="POST" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" id="first-name" class="form-control input" value="{{ Auth::user()->first_name }}" autocomplete="off"  disabled>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" id="last-name" class="form-control input" value="{{ Auth::user()->last_name }}" autocomplete="off"  disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" id="email" class="form-control input" value="{{ Auth::user()->email }}" required="required" autocomplete="off"  disabled>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="timezone" id="timezone" data-selected="{{ Auth::user()->timezone }}"  disabled>
